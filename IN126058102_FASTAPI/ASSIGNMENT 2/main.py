...
# FASTAPI DAY 4 - ALL QUESTIONS COMBINED
...
@app.get("/")
def home():
    return {"message": "FastAPI Day 4 Running"}
...
# Q5: AUDIT API (IMPORTANT: ABOVE ID ROUTE)
...
# Q4: FULL CRUD
#no code required follow the steps as previous one.
